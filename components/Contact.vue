    ...
    <div class="contact">
      <div data-aos="fade-up-right" class="contact_information">
        ...
        <div class="contact_media">
          ...
          <div class="contact_medium">
            ...
            <p>toluwanimiakinleye01@gmail.com</p>
          </div>
          <div class="contact_medium">
            <svg
              viewBox="0 0 512 512"
        ...
        <div class="contact_social">
          <a href="https://twitter.com/nimiakinleye" target="_blank"
            ><svg
              viewBox="0 0 512 512"
              style="enable-background: new 0 0 512 512"
            >
          ...
          ></a>
          <a href="https://github.com/nimiakinleye" target="_blank">
            <svg
              viewBox="0 0 512 512"
              style="enable-background: new 0 0 512 512"
            >
      ...
      <div data-aos="fade-up-left" class="contact_form">
        <form @submit.prevent="submit">
          ...
          <div class="input">
            <h1>Which of my services do you need</h1>
            <div class="checkboxes">
              <div>
                <input
                  value="Web Design"
                  type="checkbox"
                  v-model="form.job.web_design"
                />
              ...
              <div>
                <input
                  ...
                  type="checkbox"
                  v-model="form.job.web_development"
                />
              ...
              <div>
                <input
                  value="Logo Design"
                  type="checkbox"
                  v-model="form.job.logo_design"
                />
                <label for="">Logo Design</label>
              </div>
              <div>
                <input
                  value="Other"
                  type="checkbox"
                  v-model="form.job.logo_other"
                />
...
.contact .contact_information h2 {
  @apply font-semibold
  text-2xl;
}
...
.contact_media .contact_medium svg {
  @apply w-5
  mr-2
  fill-current
  text-yellow-100;
